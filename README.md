...
_Scripts to build a trimmed-down Windows 11 image - now in **PowerShell**!_
...
>
> You can see the help of the script by running the `get-help` command. 6. Select the SKU that you want the image to be based. 7. Sit back and relax :) 8. When the image is completed, you will see it in the folder where the script was extracted, with the name tiny11.iso
